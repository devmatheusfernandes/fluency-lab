...
import { GrantCreditRequest, RegularCreditType } from '@/types/credits/regularClassCredits';
...
const grantCreditSchema = z.object({
  ...
  type: z.nativeEnum(RegularCreditType, { 
    errorMap: () => ({ message: 'Tipo deve ser: bonus, late-students ou teacher-cancellation' })
  }),
...
export const POST = withValidation(
  async (request: NextRequest, validatedData: { body: z.infer<typeof grantCreditSchema> }) => {
