...
import { Settings, Calendar, Airbuds } from "@solar-icons/react/ssr";
  ...
  return (
    <Tabs defaultValue="settings">
      <div className="flex flex-row items-center justify-between w-full">
        <TabsList className="grid w-full grid-cols-3 lg:w-auto lg:grid-cols-none lg:inline-grid lg:grid-flow-col bg-slate-200 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-xl p-1 shadow-sm">
          <TabsTrigger
            value="settings"
