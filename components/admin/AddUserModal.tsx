              ...
              <>
                ...
                <ModalField label="Parentesco">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectOption value="pai">Pai</SelectOption>
                      <SelectOption value="mãe">Mãe</SelectOption>
                      <SelectOption value="responsável legal">
                        Responsável Legal
                      </SelectOption>
                      <SelectOption value="avô">Avô</SelectOption>
                      <SelectOption value="avó">Avó</SelectOption>
                      <SelectOption value="tio">Tio</SelectOption>
                      <SelectOption value="tia">Tia</SelectOption>
                      <SelectOption value="outro">Outro</SelectOption>
                    </SelectContent>
                  </Select>
                </ModalField>
