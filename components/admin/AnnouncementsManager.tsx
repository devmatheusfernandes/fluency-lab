...
import { InfoCircle, ShieldWarning } from "@solar-icons/react/ssr";
...
export function AnnouncementsManager() {
  ...
  const getTypeIcon = (type: AnnouncementType) => {
    switch (type) {
      case "info":
        return <InfoCircle className="w-5 h-5 text-blue-500" />;
      case "warning":
        return <ShieldWarning className="w-5 h-5 text-yellow-500" />;
      case "tip":
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectOption value="info">Informação</SelectOption>
                  <SelectOption value="warning">Aviso</SelectOption>
                  <SelectOption value="tip">Dica</SelectOption>
                </SelectContent>
              </Select>
            </div>
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectOption value="role">Por Função</SelectOption>
                  <SelectOption value="specific">
