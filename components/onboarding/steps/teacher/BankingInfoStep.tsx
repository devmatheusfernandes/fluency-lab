      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="p-4 mb-6 bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-700">
          <div className="flex items-start gap-3">
            <InfoCircle className="w-5 h-5 text-blue-600 dark:text-blue-400 mt-0.5 flex-shrink-0" />
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              >
                ...
                <SelectContent>
                  <SelectOption value="checking">Conta Corrente</SelectOption>
                  <SelectOption value="savings">Conta Poupança</SelectOption>
                </SelectContent>
              </Select>
              {errors.accountType && (
                <Text   size="sm" className="text-red-600 mt-1">
