...
const NotificationItem: React.FC<NotificationItemProps> = ({
  ...
  const getTypeIcon = () => {
    switch (notification.type) {
      ...
      case "warning":
        return <ShieldWarning className="w-4 h-4 text-yellow-500" />;
      case "error":
        return <ShieldWarning className="w-4 h-4 text-red-500" />;
      default:
        return <InfoCircle className="w-4 h-4 text-blue-500" />;
    }
  };
  ...
  return (
    ...
    >
      ...
      >
        <CloseCircle className="w-3 h-3 text-paragraph" />
      </button>
