    ...
    >
      <div className="flex flex-row items-center sm:items-start gap-2">
        <SkeletonLoader
          variant="avatar"
          size="lg"
          className="skeleton-base rounded-2xl w-16 h-16"
        />
        <div className="flex flex-col items-start space-y-1">
          <SkeletonLoader
            variant="text"
            lines={1}
            className="skeleton-base h-5 rounded w-32"
          />
          <SkeletonLoader
            variant="text"
            lines={1}
            className="skeleton-base h-4 rounded w-40"
          />
          <SkeletonLoader
            variant="text"
            lines={1}
            className="skeleton-base h-5 rounded w-16"
          />
        </div>
      </div>
      <SkeletonLoader
        variant="rect"
        className="skeleton-base w-10 h-10 rounded-lg"
      />
    </SkeletonLoader>
  );
};
