    ...
    return (
      <div className="flex flex-col items-center gap-2">
        <div className="text-center">
          <ShieldWarning className="w-8 h-8 text-gray-400 mx-auto mb-2" />
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-2">
          <StatusIcon className="w-5 h-5" weight="BoldDuotone" />
                ...
                <div className="space-y-4">
                  ...
                  paymentStatus.subscriptionStatus === "overdue" ? (
                    ...
                    <div className="text-center p-3 bg-card rounded-lg">
                      <ClockSquare className="w-6 h-6 text-blue-600 mx-auto mb-2" />
          ...
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              {paymentStatus.subscriptionStatus === "active" ? (
                ...
                <>
                  <ClockSquare className="w-4 h-4 text-yellow-600" />
