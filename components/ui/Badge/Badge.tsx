...
const getBadgeClasses = ({
  ...
  const baseClasses =
    "items-center text-center rounded-lg px-3 py-1 text-xs font-regular transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-1";
