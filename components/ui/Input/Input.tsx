...
const Input = React.forwardRef<HTMLInputElement, InputProps>(
  (
    ...
    const baseClasses =
      "flex w-full rounded-2xl border-2 border-container bg-container text-base text-paragraph placeholder:text-placeholder focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-primary disabled:cursor-not-allowed disabled:opacity-50 transition-all duration-200 ease-in-out hover:border-surface-2 focus:border-surface-2 focus:bg-container focus:shadow-lg";
