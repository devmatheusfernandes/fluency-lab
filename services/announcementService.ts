...
export class AnnouncementService {
  ...
  async getAnnouncementsForUser(userId: string, userRole: UserRoles): Promise<Announcement[]> {
    return await announcementRepository.getAnnouncementsForUser(userId, userRole);
  }
  ...
  async getUnreadAnnouncementCount(userId: string, userRole: UserRoles): Promise<number> {
