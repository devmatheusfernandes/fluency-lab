// services/clientAchievementDefinitions.ts
// Client-side version of achievement definitions for use in components
...
export const getClientAchievementDefinition = (
  id: string
): AchievementDefinition | undefined => {
  return clientAchievementDefinitions.find((def) => def.id === id);
};